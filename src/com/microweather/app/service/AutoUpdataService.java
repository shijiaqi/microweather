package com.microweather.app.service;

import com.microweather.app.callback.HttpCallbackListener;
import com.microweather.app.receiver.AutoUpdataReceiver;
...
public class AutoUpdataService extends Service{
	...
	private void updateWeather(){
		...
		String cityString = prefs.getString("city", "");
		String address ="http://apis.baidu.com/apistore/weatherservice/cityname?cityname="+cityString;
